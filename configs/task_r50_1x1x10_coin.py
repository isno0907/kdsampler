...
data = dict(
    ...
    train=dict(
        ...
        ann_file='data/coin/annotation/coin_task_train_list_rawframes.txt',
    ...
    val=dict(
        type='RawframeDataset',
        ann_file='data/coin/annotation/coin_task_test_list_rawframes.txt',
        data_prefix='data/coin/raw_videos',
        pipeline=[
            dict(
                type='SampleFrames',
...
work_dir = './work_dirs/task_r50_1x1x2_50e_coin_rgb/'
omnisource = False
module_hooks = []
gpu_ids = range(0, 1)
