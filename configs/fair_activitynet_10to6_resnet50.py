...
ann_file_train = 'data/ActivityNet/frameexit_anet_train_video_split.txt'
ann_file_val = 'data/ActivityNet/frameexit_anet_val_video_split.txt'
ann_file_test = 'data/ActivityNet/frameexit_anet_val_video_split.txt'
...
# optimizer
optimizer = dict(type='SGD', lr=(0.001 / 8) * (150 / 8 * 2 / 10), momentum=0.9, weight_decay=0.0001)
...
# runtime settings
dist_params = dict(backend='nccl', port=29202)
log_level = 'INFO'
work_dir = './work_dirs/fair_activitynet_10to6_resnet50'  # noqa: E501
