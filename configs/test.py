...
data = dict(
    videos_per_gpu=40,
    workers_per_gpu=8,
    val_dataloader=dict(videos_per_gpu=40, workers_per_gpu=4),
    test_dataloader=dict(videos_per_gpu=40, workers_per_gpu=4),
    train=dict(
        type=dataset_type,
...
# optimizer
optimizer = dict(type='SGD', lr=(0.001 / 8) * (120 / 8 * 1), momentum=0.9, weight_decay=0.0001)
...
log_level = 'INFO'
work_dir = './work_dirs/step_coin_10t06_resnet50'  # noqa: E501
