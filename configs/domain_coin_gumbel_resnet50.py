# model settings
model = dict(
    type='GumbelSampler2DRecognizer2D',
    use_sampler=True,
    resize_px=128,
    sampler=dict(
        type='MobileNetV2TSM',
        pretrained='modelzoo/domain_resize_tsm_mobilenetv2_1x1x10_100e_coin_rgb_remap.pth',
        is_sampler=True,
        shift_div=10,
        num_segments=10,
        total_segments=10,
...
ann_file_train = 'data/coin/annotation/coin_domain_train_list_rawframes.txt' 
ann_file_val = 'data/coin/annotation/coin_domain_test_list_rawframes.txt'
ann_file_test = 'data/coin/annotation/coin_domain_test_list_rawframes.txt'
img_norm_cfg = dict(
...
log_level = 'INFO'
work_dir = './work_dirs/domain_coin_gumbel_resnet50_t_0dot1'  # noqa: E501
evaluation = dict(
...
#evaluation = dict(interval=5, metrics=['top_k_accuracy'], gpu_collect=True)
...
load_from = 'modelzoo/domain_r50_1x1x10.pth'
resume_from = None
workflow = [('train', 1)]
