...
model = dict(
    ...
    sampler=dict(
        type='MobileNetV2TSM',
        pretrained='modelzoo/jester_resize_tsm_mobilenetv2_1x1x10_100e_coin_rgb_remap.pth',
        is_sampler=True,
        shift_div=10,
        num_segments=10,
        total_segments=10,
...
ann_file_test = 'data/jester/jester_test_list_rawframes.txt'
img_norm_cfg = dict(
...
# optimizer
optimizer = dict(type='SGD', lr=(0.001 / 8) * (80 / 8 * 1 / 1000), momentum=0.9, weight_decay=0.0001)
...
log_level = 'INFO'
work_dir = './work_dirs/jester_10to6_resnet50'  # noqa: E501
...
load_from = 'modelzoo/jester_r50_1x1x6.pth'
resume_from = None
workflow = [('train', 1)]
