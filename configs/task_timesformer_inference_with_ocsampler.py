...
model = dict(
    ...
    cls_head=dict(type='TimeSformerHead', num_classes=180, in_channels=768),
    )
...
log_level = 'INFO'
work_dir = './work_dirs/task_coin_10to6_timesformer'  # noqa: E501
...
load_from = None
again_load = 'modelzoo/task_timesformer_6x43x1_best_coin_rgb.pth'
