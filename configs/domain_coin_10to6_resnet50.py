...
# optimizer
optimizer = dict(type='SGD', lr=(0.001 / 8) * (120 / 8 * 1 / 4), momentum=0.9, weight_decay=0.0001)
...
log_level = 'INFO'
work_dir = './work_dirs/domain_coin_10to6_resnet50'  # noqa: E501
...
load_from = 'modelzoo/domain_r50_1x1x6.pth'
resume_from = None
workflow = [('train', 1)]
