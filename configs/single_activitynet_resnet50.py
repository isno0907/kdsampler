...
ann_file_val = 'data/ActivityNet/frameexit_anet_val_video.txt'
ann_file_test = 'data/ActivityNet/frameexit_anet_val_video.txt'
...
# optimizer
optimizer = dict(type='SGD', lr=(0.001 / 8) * (100 / 8 * 2), momentum=0.9, weight_decay=0.0001)
