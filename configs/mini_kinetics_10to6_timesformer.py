...
"""
train_pipeline = [
    dict(type='SampleFrames', clip_len=10, frame_interval=43, num_clips=1),
...
# optimizer
optimizer = dict(type='SGD', lr=0.001 / 8 * 100 / 16 * 1 / 8, momentum=0.9, weight_decay=0.0001)
...
log_level = 'INFO'
work_dir = './work_dirs/mini_kinetics_10to6_timesformer'  # noqa: E501
