...
data = dict(
    videos_per_gpu=200,
    workers_per_gpu=4,
    val_dataloader=dict(videos_per_gpu=120, workers_per_gpu=4),
    test_dataloader=dict(videos_per_gpu=120, workers_per_gpu=4),
    train=dict(
        type=dataset_type,
...
# optimizer
optimizer = dict(type='SGD', lr=(0.001 / 8) * (200 / 16 * 1 / 8), momentum=0.9, weight_decay=0.0001)
...
log_level = 'INFO'
work_dir = './work_dirs/minik_kd_mse_mbnv2_resnet50'  # noqa: E501
