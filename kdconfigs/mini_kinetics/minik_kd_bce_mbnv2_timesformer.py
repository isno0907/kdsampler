...
# optimizer
optimizer = dict(type='SGD', lr=(0.001 / 8) * (100 / 40 * 2 / 8), momentum=0.9, weight_decay=0.0001)
...
# runtime settings
dist_params = dict(backend='nccl', port=29712)
log_level = 'INFO'
work_dir = './work_dirs/mini_kinetics_kd_bce_mbnv2_timesformer'  # noqa: E501
