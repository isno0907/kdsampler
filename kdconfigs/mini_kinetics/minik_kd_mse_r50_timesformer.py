...
# optimizer
optimizer = dict(type='SGD', lr=(0.005 / 8) * (80 / 40 * 2 / 8), momentum=0.9, weight_decay=0.0001)
...
# runtime settings
dist_params = dict(backend='nccl', port=29704)
log_level = 'INFO'
work_dir = './work_dirs/mini_kinetics_kd_mse_r50_timesformer'  # noqa: E501
