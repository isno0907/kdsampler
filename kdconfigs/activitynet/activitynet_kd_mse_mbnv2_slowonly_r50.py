...
# optimizer
optimizer = dict(type='SGD', lr=(0.001 / 8) * (40 / 16 * 1 / 8), momentum=0.9, weight_decay=0.0001)
...
log_level = 'INFO'
work_dir = './work_dirs/activitynet_kd_mse_mbnv2_slowonly_r50'  # noqa: E501
...
load_from = 'modelzoo/anet_slowonly_classification_checkpoint.pth'
resume_from = None
workflow = [('train', 1)]
